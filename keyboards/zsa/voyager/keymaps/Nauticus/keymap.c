...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAV] = LAYOUT(
        ...
        _______, KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, _______,                   KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_ENT,
        _______, KC_MEH,  _______, _______, _______, _______,                   KC_END,  _______, _______, _______, _______, _______,
